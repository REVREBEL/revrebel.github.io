    ...
    <div className="home-container">
      <Helmet>
        ...
        <meta
          ...
          content="Welcome to the Resource Hub by REVREBEL, a go-to library for content guides. and all things related to hotel performance, system confirmation, and profit optimization to name a few. "
        />
      </Helmet>
        ...
        <div className="section-container">
          <div className="home-max-width2 max-content-container">
            ...
            <div className="home-tab-selector-cards-container">
              <PortofolioCard
                image_src="/unsplash_qj15unotnh0-400h.png"
                rootClassName="portofolio-card-root-class-name"
              ></PortofolioCard>
              <PortofolioCard
                image_src="/unsplash_wwqrpsnbpq4-400h.png"
          ...
          <div className="home-max-width5 max-content-container">
            ...
            <div className="home-blog-cards-container">
              ...
              <BlogCard
                text1="Aug 14, 2022"
                button="advertising"
                image_src="/rectangle%2099%20%5B1%5D-1500w.png"
                rootClassName="blog-card-root-class-name1"
              ></BlogCard>
              <BlogCard
                text1="Jul 12, 2022"
                button="Branding"
                image_src="/unsplash_h7qmwoxf6z8-1500w.png"
              ></BlogCard>
            </div>
          </div>
        </div>
